...
| **Id** | ADR-025 |
| **Date** | 2026-08-20 |
| **Source** | decision-ledger row for ADR-025, compiled 2026-08-21 |

## Summary

Pipeline terminates at a self-contained publication-ready artifact; rendering it (to Confluence or elsewhere) is a separate adapter concern.
...
- **Discussed in the digest at**: §1.2 The cascade (ADR-017), §1.3 Core architectural model, §1.4 Module boundaries (ADR-040, ADR-041, ADR-042), §2. Tech stack
