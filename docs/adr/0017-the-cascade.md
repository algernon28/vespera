...
| **Id** | ADR-017 |
| **Date** | 2026-08-20 |
| **Source** | decision-ledger row for ADR-017, compiled 2026-08-21 |

## Summary

Defines the 8-stage pipeline (0–7) and the verdicts each stage writes. Cheapest filter runs first.
