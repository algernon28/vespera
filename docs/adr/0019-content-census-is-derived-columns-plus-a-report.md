# ADR-019 — Content census is derived columns plus a report
...
| **Id** | ADR-019 |
| **Date** | 2026-08-20 |
| **Source** | decision-ledger row for ADR-019, compiled 2026-08-21 |

## Summary

Not a second traversal — extraction writes per-occurrence metrics as columns while the document is open.
