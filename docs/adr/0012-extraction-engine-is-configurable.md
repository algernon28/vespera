# ADR-012 — Extraction engine is configurable
...
| **Id** | ADR-012 |
| **Date** | 2026-08-20 |
| **Source** | decision-ledger row for ADR-012, compiled 2026-08-21 |

## Summary

Serving runtime is config, not code. Cache key must carry full extractor identity; calibration must not cross engines.
