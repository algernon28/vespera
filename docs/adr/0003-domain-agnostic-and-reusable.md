# ADR-003 — Domain-agnostic and reusable
...
| **Id** | ADR-003 |
| **Date** | 2026-08-20 |
| **Source** | decision-ledger row for ADR-003, compiled 2026-08-21 |

## Summary

Corpus content unknown and unassumed; domain judgement externalised to a per-corpus input.
...
- **Names**: _none_
- **Named by**: _none_
- **Discussed in the digest at**: §1.1 What it does
