# ADR-027 — Clustering moves to stage 5
...
| **Id** | ADR-027 |
| **Date** | 2026-08-20 |
| **Source** | decision-ledger row for ADR-027, compiled 2026-08-21 |

## Summary

Amends ADR-017/ADR-022 ordering — stage 5 already embeds everything, so clustering there is nearly free and precedes threshold-setting. *(Scope clarified by ADR-045.)*

## Cross-references

Extracted mechanically from the digest; the direction of an amendment is only as explicit as the summary above makes it.

- **Names**: [ADR-017](0017-the-cascade.md), [ADR-022](0022-stage-6-splits-into-arrangement-6a-then-generation-6b.md), [ADR-045](0045-clustering-runs-within-each-seed-partition.md)
- **Named by**: _none_
