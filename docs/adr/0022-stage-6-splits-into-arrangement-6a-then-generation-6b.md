...
| **Id** | ADR-022 |
| **Date** | 2026-08-20 |
| **Source** | decision-ledger row for ADR-022, compiled 2026-08-21 |

## Summary

6a builds a page tree (seed-named top level + `unattributed`, clusters within); 6b generates cited overviews, gated on human review of 6a.
...
- **Names**: _none_
- **Named by**: [ADR-027](0027-clustering-moves-to-stage-5.md)
