...
| **Id** | ADR-015 |
| **Date** | 2026-08-20 |
| **Source** | decision-ledger row for ADR-015, compiled 2026-08-21 |

## Summary

Keyed on file occurrence (path/size/mtime, hash nullable) — not path, not content hash. Content identity is a discovered relation, not a collapse.
