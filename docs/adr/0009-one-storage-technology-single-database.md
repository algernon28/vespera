# ADR-009 — One storage technology; single database
...
| **Id** | ADR-009 |
| **Date** | 2026-08-20 |
| **Source** | decision-ledger row for ADR-009, compiled 2026-08-21 |

## Summary

SQLite replaces flat-file artifacts, scoped to census. *Clarified same day:* not a ban on a separate vector store — relational and vector stores serve different purposes.
