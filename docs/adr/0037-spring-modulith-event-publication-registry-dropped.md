# ADR-037 — Spring Modulith event publication registry dropped
...
| **Id** | ADR-037 |
| **Date** | 2026-08-20 |
| **Source** | decision-ledger row for ADR-037, compiled 2026-08-21 |

## Summary

No application events exist in this design; registry also lacked a SQLite schema and threw a hard startup failure. `starter-core` retained for boundary checks.
