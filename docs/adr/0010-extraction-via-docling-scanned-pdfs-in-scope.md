# ADR-010 — Extraction via Docling; scanned PDFs in scope
...
| **Id** | ADR-010 |
| **Date** | 2026-08-20 |
| **Source** | decision-ledger row for ADR-010, compiled 2026-08-21 |

## Summary

Extraction is out-of-process, returns a structured document (not plain text), is cached under full extractor identity, and can fail silently.
