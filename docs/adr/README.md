...
One file per architecture decision, ADR-001 through ADR-115, and ADR-118.
...
| [ADR-118](0118-profiles-canonical-constructor-is-its-only-public-one-and-test-convenience-lives-in-the-tests.md) | 2026-09-14 | `Profile`'s canonical constructor is its only public one, and test convenience lives in the tests |
