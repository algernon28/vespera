...
| [ADR-120](0120-a-profile-values-type-is-its-keys-and-an-unreadable-value-is-a-third-state-beside-unset.md) | 2026-09-15 | A profile value's type is its key's, and an unreadable value is a third state beside unset |
