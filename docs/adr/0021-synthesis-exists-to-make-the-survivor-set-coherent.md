# ADR-021 — Synthesis exists to make the survivor set coherent
...
| **Id** | ADR-021 |
| **Date** | 2026-08-20 |
| **Source** | decision-ledger row for ADR-021, compiled 2026-08-21 |

## Summary

Clarifies ADR-002: stage 5 leaves a heap; synthesis is connective material about the collection, not per-document summarisation.
...
- **Named by**: _none_
- **Discussed in the digest at**: §1.1 What it does, §1.3 Core architectural model
