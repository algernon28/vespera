# ADR-016 — The corpus is treated as static
...
| **Id** | ADR-016 |
| **Date** | 2026-08-20 |
| **Source** | decision-ledger row for ADR-016, compiled 2026-08-21 |

## Summary

One archive, walked once; re-walks happen because code changed, not content. Explicit assumption, not a discovered property.
