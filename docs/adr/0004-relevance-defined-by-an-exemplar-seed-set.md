# ADR-004 — Relevance defined by an exemplar seed set
...
| **Id** | ADR-004 |
| **Date** | 2026-08-20 |
| **Source** | decision-ledger row for ADR-004, compiled 2026-08-21 |

## Summary

"Trash" includes topical irrelevance. Relevance supplied per corpus as a folder of known-relevant documents; one-class (positives only).
