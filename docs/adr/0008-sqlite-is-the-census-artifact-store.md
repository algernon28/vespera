# ADR-008 — SQLite is the census artifact store
...
| **Id** | ADR-008 |
| **Date** | 2026-08-20 |
| **Source** | decision-ledger row for ADR-008, compiled 2026-08-21 |

## Summary

Amends ADR-006's file formats. Aggregates/collisions/run identity become queries. Phase-A immutability becomes a convention, not a filesystem guarantee.

## Cross-references

Extracted mechanically from the digest; the direction of an amendment is only as explicit as the summary above makes it.

- **Names**: [ADR-006](0006-census-measure-before-judging.md)
- **Named by**: _none_
