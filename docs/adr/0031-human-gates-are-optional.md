# ADR-031 — Human gates are optional
...
| **Id** | ADR-031 |
| **Date** | 2026-08-20 |
| **Source** | decision-ledger row for ADR-031, compiled 2026-08-21 |

## Summary

A gate is a required input, not a pause. Profile carries every gate input with per-value provenance (human/carried-over/auto-derived).
