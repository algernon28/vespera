...
| **Id** | ADR-005 |
| **Date** | 2026-08-20 |
| **Source** | decision-ledger row for ADR-005, compiled 2026-08-21 |

## Summary

Corners may be cut on anything reversible — never on destructive deletion, lost provenance, or un-cached expensive extraction.
