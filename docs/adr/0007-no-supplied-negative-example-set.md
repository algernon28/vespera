# ADR-007 — No supplied negative example set
...
| **Id** | ADR-007 |
| **Date** | 2026-08-20 |
| **Source** | decision-ledger row for ADR-007, compiled 2026-08-21 |

## Summary

Trash is the unbounded complement of relevance. Hand-picked negatives are uninformative; hard negatives must be mined post-scoring.
