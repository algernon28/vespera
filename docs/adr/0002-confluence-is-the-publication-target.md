# ADR-002 — Confluence is the publication target

> **Superseded — see ADR-101.** [ADR-101](0101-the-run-ends-at-the-generated-documents-there-is-no-publication-stage-and-no-publication-target.md) **supersedes this record**: there is no publication target. The run ends at the documents stage 6b generates.
...
| **Id** | ADR-002 |
| **Date** | 2026-08-20 |
| **Source** | decision-ledger row for ADR-002, compiled 2026-08-21 |

## Summary

Curated output published as surviving originals + synthesised docs. Confluence is the sink, not the working store. *(Softened by ADR-024, refined by ADR-025.)*

## Cross-references

Extracted mechanically from the digest; the direction of an amendment is only as explicit as the summary above makes it.

- **Names**: [ADR-024](0024-publication-is-terminal-and-one-shot.md), [ADR-025](0025-stage-7-is-an-adapter-not-a-stage.md)
- **Named by**: [ADR-021](0021-synthesis-exists-to-make-the-survivor-set-coherent.md), [ADR-024](0024-publication-is-terminal-and-one-shot.md)
