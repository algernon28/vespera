# ADR-035 — Pipeline never publishes; adapter invoked separately, never unattended

> **Superseded — see ADR-101.** [ADR-101](0101-the-run-ends-at-the-generated-documents-there-is-no-publication-stage-and-no-publication-target.md) **supersedes this record**: its rule that the pipeline never publishes survives in the only way it can — nothing publishes.
...
| **Id** | ADR-035 |
| **Date** | 2026-08-20 |
| **Source** | decision-ledger row for ADR-035, compiled 2026-08-21 |

## Summary

Pipeline runs unattended through 6b; publication is a distinct, always human-initiated invocation.
