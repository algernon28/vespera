# ADR-033 — Embedding model: criteria recorded, model unset
...
| **Id** | ADR-033 |
| **Date** | 2026-08-20 |
| **Source** | decision-ledger row for ADR-033, compiled 2026-08-21 |

## Summary

Requirements: separable tokenizer, pinned weights, Italian+English, judged on Clustering/STS not Retrieval, OCR tolerance. Several candidates evaluated and rejected on criteria; model ships unset.
