...
**`docs/adr/`** holds 152 decisions, ADR-001 to ADR-154 — ADR-150 and ADR-151 are reserved by ADR-149 §9 for #286 and #287 and not yet written — and two things about it are invisible from the files:
