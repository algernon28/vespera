...
**`docs/adr/`** holds 151 decisions, ADR-001 to ADR-153 (ADR-150 is in flight on another branch, and ADR-152 on pull request #293), and two things about it are invisible from the files:
