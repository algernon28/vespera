...
**`docs/adr/`** holds 150 decisions, ADR-001 to ADR-153 — ADR-150 and ADR-151 are reserved by ADR-149 §9 for #286 and #287, and ADR-152 is in flight on an open pull request — and two things about it are invisible from the files:
