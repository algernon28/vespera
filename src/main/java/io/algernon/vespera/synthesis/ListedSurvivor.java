 ...
 * already holds, gathered here as a plain value so {@link Deliverable} needs no capability module
 * this ticket did not already name (ADR-110).
 *
 ...
 * @param contentHash the SHA-256 stage 1 recorded for it (ADR-067)
