...
/**
 * One cluster fault as stage 6b wrote it down: the group it was about, and why its answer was
 * turned down.
 *
 * <p>The group travels as the two columns that identify it, as {@link RecordedSynthesisDoc} carries
 * it — 6a's own row gives the group its place; this carries only what 6b recorded (ADR-110, ADR-111).
 *
