 ...
 * rows into seeds and groups is this module's work rather than the caller's — {@code pipeline} reads
 ...
 * @param clusterOrdinal the group the previous stage put it in, which is that group's identity
