...
/**
 * A verdict {@link Stage2ItemProcessor} decided to write for one occurrence — always
 ...
 * all: {@link Stage2ItemProcessor} returns {@code null} for those, which Spring Batch reads as "filter
 * this item" rather than "write nothing for it" — an occurrence carries no row until a stage actually
 * judges it.
 */
record Stage2Outcome(OccurrenceId occurrenceId, VerdictKind kind, String reason) {}
